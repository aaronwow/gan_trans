...
const _openRouter = ProviderSpec(
  ...
  models: [
    ...
    // OpenAI
    ModelSpec(id: 'openai/gpt-5.4', label: 'GPT-5.4', caps: {Capability.chat}),
    ModelSpec(
    ...
    ModelSpec(id: 'openai/gpt-4.1', label: 'GPT-4.1', caps: {Capability.chat}),
    ModelSpec(
      id: 'openai/gpt-4.1-mini',
      label: 'GPT-4.1 Mini',
      caps: {Capability.chat},
    ),
    ModelSpec(id: 'openai/gpt-4o', label: 'GPT-4o', caps: {Capability.chat}),
    ModelSpec(
